...
export default function ServiceCard(){
    ...
    return <div className="flex flex-col max-w-xs bg-white border border-black rounded-lg py-2 divide-y">
        ...
        <div className="flex flex-row space-x-2 px-4 items-center" >
            ...
            <h1 className="flex-grow font-semibold">Public</h1>
        ...
        <div className="flex flex-col px-4 pt-4" >
            <h1 className="flex-grow text-xl font-semibold hover:underline cursor-pointer">Teeths</h1>
            <p 
            className="text-md" 
...
Order 3013717520787266 has a delivery update. You can view the shipping status below.
            ...
            <div className="flex flex-row mt-4">
                <h1 className="flex-grow">Free</h1>
                00:15
            </div>
        </div>
    </div>
